...
(
	...
	DATA_PREVISTA VARCHAR(2) CHECK (DATA_PREVISTA IN ('S', 'N')),
	...
	COQUELUCHE VARCHAR(2) CHECK (COQUELUCHE IN ('S', 'N')),
...
(
	...
	FORMACAO VARCHAR (9) NOT NULL CHECK (FORMACAO IN ('1º Grau', '2º Grau', 'Superior')),
